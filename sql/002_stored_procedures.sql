...
CREATE OR ALTER PROCEDURE dbo.UarRequest_Create
    ...
    @Status NVARCHAR(100),
    @AuthorizedApproverName NVARCHAR(200),
    @AuthorizedApproverEmail NVARCHAR(200),
    @ProgramAdministratorName NVARCHAR(200),
    @ProgramAdministratorEmail NVARCHAR(200),
    @RdoApproverName NVARCHAR(200),
    @RdoApproverEmail NVARCHAR(200),
...
BEGIN
    ...
    INSERT INTO dbo.UarRequests (
        ...
        Status, AuthorizedApproverName, AuthorizedApproverEmail, ProgramAdministratorName,
        ProgramAdministratorEmail, RdoApproverName, RdoApproverEmail, RejectionReason, EmailAccount,
...
BEGIN
    ...
    SET RequestNumber = @RequestNumber,
        ...
        Status = @Status,
        AuthorizedApproverName = @AuthorizedApproverName,
        AuthorizedApproverEmail = @AuthorizedApproverEmail,
        ProgramAdministratorName = @ProgramAdministratorName,
        ProgramAdministratorEmail = @ProgramAdministratorEmail,
        RdoApproverName = @RdoApproverName,
        RdoApproverEmail = @RdoApproverEmail,
